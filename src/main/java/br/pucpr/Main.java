...
public class Main {
  public static void main(String[] args) {
    ...
    System.out.println("-------------------");
    var usersData = new UsersPrinter(usuarios, true);
    Table.print(usersData, true, LIGHT);
    ...
    System.out.println("-------------------");
    var planetasData = new PlanetasPrinter(planetas);
    Table.print(planetasData, false, Theme.NORMAL);
  }
}
